    ...
    return (
        <div className="cards">
            ...
            <div className="cards__container">
                ...
                <ul className="cards__items">
                    <CardItem src="../images/img-9.jpg" text="Explore the hidden waterfall deep inside the Amazon Jungle" label="Adventure" path="/services"/>
                    <CardItem src="../images/img-8.jpg" text="Ride through the Sahara Desert on a guided Camel Tour" label="Luxury" path="/services"/>
                    <CardItem src="../images/img-4.jpg" text="Experience Football on top of The Himalayan Mountains" label="Luxury" path="/services"/>
                </ul>
            </div>
        </div>
    )   
